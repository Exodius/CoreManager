...
(
  ...
  'zone' => 'Zone',
  'online' => 'Online',
  'no_friends' => 'No characters in Friends list.',
  'no_ignores' => 'No characters in Ignored list.',
  'no_friend_of' => 'Not on any Friends lists.',
  'no_ignored_by' => 'Not on any Ignored lists.',
    // ---- char_edit.php ----
...
(
  ...
  'coupon_contest' => 'Contest',
  'coupon_contest_tip' => 'Coupon will only be available to the winner or winners of the specified Achievement Contest.<br />Use 0 (ZERO) when this coupon will <b>not</b> be used by an Achievement Contest.',
  'coupon_contest_id' => 'Ach. Contest ID',
  ...
  'contest_add' => 'Add New Achievement Contest',
  'contest_id' => 'ID',
  'contest_realm' => 'Realm',
  'contest_realm_tip' => 'Realm ID that will be used for this Contest.<br /><b>If not set, Contest will be ignored.</b>',
  'contest_realm_warn' => 'REQUIRED!',
  'contest_achieve_id' => 'Achievement',
  'contest_ach_id' => 'Achievement ID',
  'contest_issued' => 'Date Issued',
  'contest_after_only' => 'After Only',
  'contest_after_only_tip' => "Contest will only take into account Achievements Unlocked <i>after</i> the Contest\'s Issue Date.",
  'contest_prize_bag' => 'Prize Bag ID',
  'contest_prize_bag_tip' => "To award a Coupon instead of a Prize Bag, use -1 times the Coupon\'s ID.<br />Note: You should indicate this Achievement Contest\'s ID in the specified Coupon to prevent the Coupon from being generally available.",
  'contest_winner' => 'Winner GUID',
  'contest_enabled' => 'Enabled',
  'contest_expiration' => 'Ending Date',
  'contest_expires_year' => 'Year',
  'contest_expires_month' => 'Month',
  'contest_expires_day' => 'Day',
  'contest_expires_hour' => 'Hour',
  'contest_expires_minute' => 'Minute',
  'contest_expires_tip' => 'Hour must be in range 0-23',
  'contest_announce' => 'Announcement',
  'contest_announce_tip' => 'How the announcement Server Message will be targeted.<br>Global: Everyone will be able to see announcement of winner.<br>Private: only winner will see announcement.',
  'contest_announce_global' => 'Global',
  'contest_announce_private' => 'Private',
  'contest_announce_msg' => 'Message',
  'contest_announce_msg_tip' => 'The message that will be displayed in the announcement Server Message.<br>The following replacements will be made:<br>%1 with Winning Character Name<br>%2 with Contest Achievement Name<br><br>Note: it is recommended that you create the message in the Server Messages Page and copy it here.',
...
(
  ...
  'no_coupons' => 'There are no Coupons to display at this time.',
  'no_raffles' => 'There are no Raffles to display at this time.',
  'no_contests' => 'There are no Achievement Contests to display at this time.',
